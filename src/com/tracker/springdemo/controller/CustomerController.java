...
public class CustomerController{
	...
	//@Autowired   //this is removed because we are getting it from service layer now
	...
	public String saveCustomer(@ModelAttribute("customer") Customer theCustomer) {
		...
		customerService.saveCustomer(theCustomer);//->Insert new record as per hibernate methods
		//use saveOrupdate method ->made changes to daoImpl
